(function () {
  ...
  var API_KEY = "-aRcOqJ2QIOS6JKc6lIgzQ";
   ...
   */
  var API_SECRET = "CTMOruNxF5Gj7DKx3FI0AIeKcGB0LLhDfkF6";

  document.getElementById("meeting_pwd").value = "9SJHB9";
        testTool.setCookie("meeting_pwd", "9SJHB9");

  var meetingConfig = testTool.getMeetingConfig();
  meetingConfig.name="1.8.3#CDN";
  meetingConfig.mn=5169147372;
  meetingConfig.pwd="ZS1A2u";
